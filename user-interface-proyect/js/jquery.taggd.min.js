	...
	****************************************************************/
	...
	Taggd.prototype.addDOM = function() {
		...
		$.each(this.data, function(i, v) {
			...
			if(typeof _this.options.hoverRender != undefined || typeof v.text === 'string' && (v.text.length > 0 || _this.options.edit)) {
				//romina
				console.log("typeof hoverRender ="+_this.options.hoverRender);
				if(typeof _this.options.hoverRender == undefined) {
					$hover = $('<span class="taggd-item-hover" style="position: absolute;" />').html(v.text);
				} else {
					$hover = $(_this.options.hoverRender(_this, v));
				}
				$hover.attr({
					'data-x': v.x,
					'data-y': v.y
